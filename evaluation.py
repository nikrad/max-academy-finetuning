...
# Set up logging
logging.basicConfig(
    filename="output.log", level=logging.DEBUG, format="%(message)s"
)  # Remove timestamp and log level
console = logging.StreamHandler()
console.setLevel(logging.INFO)
console.setFormatter(
    logging.Formatter("%(message)s")
)  # Remove timestamp and log level for console output
...
async def main():
    ...
    # ]
    models = [
        "ft:gpt-4o-mini-2024-07-18:personal:training-500-1:AGFBlVcq",
        "ft:gpt-3.5-turbo-0125:personal:training-500-1:AGFGuTf3",
    ]
